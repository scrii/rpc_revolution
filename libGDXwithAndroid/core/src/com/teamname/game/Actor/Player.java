...
public class Player extends Actor {
    ...
    public Player(String nickname,Texture img, Point2D position, float Speed, float R, float health, PlayerDataCreator playerData) {
    ...
    public void update() {
       ...
       // test push = GdxFIRDatabase.instance().inReference("test").push().setValue(new Message("metadata"));
        ...
        if(isMove){playerData.update(send_in_ONLINE);
            //playerCollectData.getPosition(nickname);
