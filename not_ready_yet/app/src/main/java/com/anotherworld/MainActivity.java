package main.java.com.anotherworld;
...
public class MainActivity extends AppCompatActivity {
    ...
    private FirebaseListAdapter<com.anotherworld.Message> adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        libGDX.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    if (pm.getApplicationInfo("com.android.vending", 0) == null) {
                        // no talk, no update
                        Toast.makeText(getApplicationContext(), "packagenot found", Toast.LENGTH_SHORT).show();

                    } else {
                        Intent packageIntent= pm.getLaunchIntentForPackage("com.android.vending");
